		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="<s:url value="/subjects"/> ">Subject</a>
                    </li>
                    <li class="page-scroll">
                        <a href="<s:url value="/users/"/> ">All Users</a>
                    </li>            
                </ul>                				
					...
					<div class="active-links">
						<div id="session">
							<a id="signin-link" href="#"> Welcome <strong><s:property
										value="%{#session.username}" />!</strong>
							</a>
						</div>
						<div id="signin-dropdown">
							<a href="<s:url value="/logout"/>">Logout</a><br> <a
								href="<s:url value="/users/detail%{#session.userid}"/>">View
								profile</a><br>
						</div>
					</div>
				</s:else>
